...
describe('getPlatformAdminSummary', () => {
  it('summarizes tenants, billing, storage, and sync health', () => {
    ...
    // Only active/trial tenants count: pro (1.490.000) + starter (1.250.000) = 2.740.000
    expect(summary.monthlyRecurringRevenue).toBe('Rp 2.740.000')
