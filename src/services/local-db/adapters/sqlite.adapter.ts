...
class SqliteAdapterImpl implements LocalDbAdapter {
  ...
  private async initializeSchema(): Promise<void> {
    ...
    const tableSchemas: Record<string, string> = {
      ...
      accounts: `id TEXT PRIMARY KEY, tenantId TEXT, code TEXT, name TEXT, type TEXT, isSystem INTEGER, isActive INTEGER, syncStatus TEXT, version INTEGER, updatedAt TEXT`,
      journalEntries: `id TEXT PRIMARY KEY, tenantId TEXT, code TEXT, description TEXT, referenceType TEXT, referenceId TEXT, date TEXT, syncStatus TEXT, version INTEGER, updatedAt TEXT`,
      journalLines: `id TEXT PRIMARY KEY, tenantId TEXT, journalEntryId TEXT, accountId TEXT, accountCode TEXT, debit REAL, credit REAL, syncStatus TEXT, updatedAt TEXT`,
