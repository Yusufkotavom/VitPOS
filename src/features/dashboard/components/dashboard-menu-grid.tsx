...
const GROUP_COLORS: Record<string, { bg: string; text: string; iconBg: string }> = {
  ...
  katalog_stok: { bg: 'hover:bg-orange-50', text: 'text-orange-600 dark:text-orange-400', iconBg: 'bg-orange-100 dark:bg-orange-900/40' },
  relasi_bisnis: { bg: 'hover:bg-indigo-50', text: 'text-indigo-600 dark:text-indigo-400', iconBg: 'bg-indigo-100 dark:bg-indigo-900/40' },
  keuangan_laporan: { bg: 'hover:bg-purple-50', text: 'text-purple-600 dark:text-purple-400', iconBg: 'bg-purple-100 dark:bg-purple-900/40' },
  ...
  return (
    <div className="flex flex-col gap-5">
      {sidebarNavigation(t).map((group) => {
        ...
        const colors = GROUP_COLORS[group.key] || DEFAULT_COLORS
