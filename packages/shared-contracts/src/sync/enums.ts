export type SyncEntityType = 'product' | 'customer' | 'sale' | 'payment' | 'stock_movement' | 'cash' | 'cash_category' | 'setting' | 'shift' | 'product_category' | 'supplier' | 'purchase' | 'return' | 'service_order'
