...
export function ReturnForm({ defaultValues, submitLabel, onCancel, onSubmit }: { defaultValues?: ReturnFormValues; submitLabel: string; onCancel: () => void; onSubmit: (values: ReturnFormValues) => Promise<void> }) {
  ...
  return (
    <form className="flex flex-col gap-4 p-4" onSubmit={form.handleSubmit(onSubmit)}>
      <FormSection title="Info retur" description="Nomor retur, tipe, referensi, dan status.">
        <label className="flex flex-col gap-1 text-sm font-medium">
          Nomor retur
          <Input aria-invalid={Boolean(errors.code)} {...form.register('code')} placeholder="RET-20260608-001" />
      ...
      <FormSection title="Item retur" description="Produk yang diretur beserta qty dan harga.">
